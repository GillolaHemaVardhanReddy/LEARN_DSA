...
================================================================
  Given a string of uppercase letters and integer k, you may replace AT MOST k characters with any letter. Find the longest substring of a single repeated letter you can make.
