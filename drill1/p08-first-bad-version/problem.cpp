...
================================================================
  Versions 1..n are in order; from some version onward everything is bad and stays bad. Given an isBad(v) check, find the FIRST bad version with the fewest checks.
