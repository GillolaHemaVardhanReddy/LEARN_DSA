/*
================================================================
  DRILL 1  —  Problem 33   [HARD]
================================================================
  Find the SHORTEST substring of s that contains every character of t (with multiplicity). Return "" if none.

  Example:     s="ADOBECODEBANC", t="ABC"  ->  "BANC"
  Constraints: 1 <= len(s),len(t) <= 1e5
