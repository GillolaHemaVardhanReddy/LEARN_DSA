...
- **Date:** 2026-07-05 (**M9 Recursion OPENED → L3 · all notes rebuilt to teaching-BITS · memoization taught**)
...
| M9 Recursion | **L3** | [008-012] | ladder (print/sum/factorial/reverse/palindrome/fib) · LC70 | L4 pending judge-ACs; `'hi'`→`"hi"` fix in 01 | LC509 + LC344 + LC125 → L4; recall +1d 7/06 |
