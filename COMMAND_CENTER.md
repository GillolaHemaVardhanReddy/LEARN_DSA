...
- **Current topic / workspace:** **practice/drills/02-monotonic-stack — P4 LC402 ✅ JUDGE-AC (2026-06-29)! Now starting P5 LC84 Largest Rectangle in Histogram (HARD).** P1–P3 reported done (**P3 Asteroid Collision = working-tree edits, judge-AC unconfirmed**). LC402 pattern = **greedy monotonic-INCREASING build** ("pop bigger predecessors while k>0 · trim leftover k from the END · strip leading zeros · empty→`0`").
