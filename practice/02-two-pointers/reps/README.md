...
## The 3 shapes (from `practice/02-two-pointers/notes.md`)
...
## After the set
We fill the `🔲 TO FILL AFTER REPS` section of `practice/02-two-pointers/notes.md` with your real cues + gotchas,
