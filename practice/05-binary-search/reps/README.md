...
## The 4 knobs (from `practice/05-binary-search/notes.md`)
...
## Cadence
This week: **01–04** (2 easy + 2 medium). **05 (hard) → weekend.** After the set: fill `practice/<NN-topic>/notes.md → 06` TO-FILL + spaced drill later.
