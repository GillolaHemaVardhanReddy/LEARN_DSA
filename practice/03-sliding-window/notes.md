...
> (The terse cue lives in `dashboard/PATTERN_JOURNAL.md`; this is the "explain it to me like a human" version.)
...
---
_This note teaches the model; dashboard/PROGRESS.md holds the mastery level. Last restructured into teaching-BITS format._
