...
Taught me by: theory + **generic NGE warm-up (100k stress green) = L3 (6/23)** + **LC739 Daily Temperatures (distance variant) + LC503 NGE II (circular) both judge-AC = L4 (6/25)** + **LC456 132 Pattern (track-best-2 R→L, over-revealed, re-derive owed)**; Striver [301][303][302][311]. Next for depth: Stock Span (LC901, previous-greater + span count) + histogram-area.
