...
| **when free (PRACTICE)** | **M9 recursion practice ladder** (`phase-2/practice/09-Recursion/README.md`) | reps | solo (help-allowed) | Confidence ladder, 4 tiers: T1 pure-recursion wins (LC509/1137/344/231/**50 Pow fast-power**) · T2 branching+memo DP on-ramp (LC746/**198 House Robber**) · T3 generate/backtracking bridge (LC78/46) · T4 recursion on structures (LC206/104). Clear T1+T2 = recursion-confident + banks M9 L4 judge-ACs. Scaffold just-in-time. |
