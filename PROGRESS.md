...
- Overall mastery (started topics): **~77%** (mean of M1 L3*=55, M2 L4=75, M3 L4=75, M4 L5=90, M5 L5=90, M6 L4=75 → 460/6). First two patterns at L5 (recognition cold).
...
| M5 | Prefix Sum | **L5** | 2026-06-10 | 1/3 | **L5 RECOGNIZED 2026-06-10**: drill Q4 (count subarrays=k WITH negatives) named cold + spoke the exact trigger ("breaks in sliding window ⇒ prefix+hash"). L4 prior: LC560/LC974/LC525 mediums AC + LC724. |
